...
export default function History() { //function responsavel por guardar as jogadas anteriores
  const {
    history,
    setHistory,
    setSquares,
  ...
  function handleClick(index) {
    const newHistory = [...history]; //adiciona dentro de um array as jogadas anteriores
